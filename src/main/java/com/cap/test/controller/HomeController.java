...
/*
	//API
	@ResponseBody
	@RequestMapping(value="/user/searching",method=RequestMethod.GET,produces="application/text;charset=utf8")
	public String searching(SearcingVO vo) {
	       ...
	       // String jsonParse = ""; //JSON 형태로 변환된 문자열
	        ...
	        String apiURL = "https://openapi.naver.com/v1/search/shop?query=" +text+"&display="+display;    //12 json 결과
